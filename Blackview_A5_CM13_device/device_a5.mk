...
$(call inherit-product-if-exists, vendor/blackview/a5/a5-vendor.mk)

LOCAL_PATH := device/blackview/a5
...
PRODUCT_COPY_FILES += \
     ...
     $(LOCAL_PATH)/rootdir/system/etc/tp/.thermal_policy_00:system/etc/.tp/.thermal_policy_00
...
PRODUCT_COPY_FILES += \
     ...
     $(LOCAL_PATH)/rootdir/system/usr/keylayout/ACCDET.kl:system/usr/keylayout/ACCDET.kl \
     $(LOCAL_PATH)/rootdir/system/usr/keylayout/AVRCP.kl:system/usr/keylayout/AVRCP.kl
